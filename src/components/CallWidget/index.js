...
export default function CallWidget({ closeControlCenter }) {
  ...
  return (
    <Box sx={{ width: '100%', overflow: 'hidden', height: '100%' }} onClick={() => {
      publish(uiEvents.CLOSE_CONTROL_CENTER, {});
      publish(uiEvents.OPEN_CALL, {});
    }}>
      <Widget>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <CoverImage>
            <Avatar style={{ width: '100%', height: '100%' }} sx={{ bgcolor: blue[600] }}>
              M
            </Avatar>
          </CoverImage>
