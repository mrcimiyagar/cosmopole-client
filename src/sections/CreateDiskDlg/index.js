...
import { createDisk } from "../../core/callables/storage";
import { colors } from "../../config/colors";
import { yellow } from "@mui/material/colors";

export let closeExplore = () => { };

export default function CreateDiskDlg({ filespaceId, tag }) {
      ...
      >
        ...
        >
          <Toolbar>
            ...
            <Typography style={{color: colors.textPencil}}>Create Disk</Typography>
          </Toolbar>
        </div>
